package com.isoterik.xgdx.x2d.animation;
...
import com.isoterik.xgdx.x2d.components.animation.SpriteAnimator;

/**
 * Used for animating sprites. SpriteAnimations are managed by a {@link SpriteAnimator} to
...
public class SpriteAnimation implements State<GameObject> {
	...
	public void update(GameObject go) {
		...
		SpriteRenderer sr = go.getComponent(SpriteRenderer.class);
		if (sr != null) {
			sr.setSprite(update(XGdx.instance().getDeltaTime()));
		}
	}
